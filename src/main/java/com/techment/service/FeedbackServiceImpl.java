...
public class FeedbackServiceImpl implements IFeedbackService {
	...
	Feedback newFeed= new Feedback(feedback.getRating(), feedback.getFeedbackComment());
	...
	public List<FeedbackDto> GetAllFeedback() {
		...
		{
			feedbackList.add(new FeedbackDto(feedback.getRating(), feedback.getFeedbackComment()));			
		}
	...
	public FeedbackDto GetFeedbackById(int id) {
		...
		//FeedbackDto feedbackdto =new FeedbackDto(feedback.getRating(), feedback.getFeedbackComment());
